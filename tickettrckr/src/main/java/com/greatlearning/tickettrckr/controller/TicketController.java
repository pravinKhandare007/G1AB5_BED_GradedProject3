...
public class TicketController {
	...
	public String updateTicket(@ModelAttribute(name = "ticket") Ticket tckk, @PathVariable("id") Integer id) {		
		Ticket existingTicket = ticketService.getTicketById(id);
		if (existingTicket.getId() == tckk.getId()) {
			existingTicket.setTitle(tckk.getTitle());
			existingTicket.setDiscription(tckk.getDiscription());
			existingTicket.setCreatedon(tckk.getCreatedon());
		}
